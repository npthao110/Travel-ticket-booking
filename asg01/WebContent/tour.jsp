...
<body>
	...
	if (searchQuery == null || "".equals(searchQuery.trim())) {
		...
		travels = travelDAO.searchTravel(searchQuery);
	}
...
%>
		...
		<div class="container">
			<div
				...
				<div class="col-md-9 ftco-animate text-center"
					...
					<h1 class="mb-3 bread"
						data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Destination</h1>
				</div>
			</div>
		</div>
	</div>
							...
							<div class="col-md-4 ftco-animate">
								<div class="destination">
									<a href="#"
										...
										style="background-image: url(${travel.imageDescription});">
										<div
											...
											<div class="one">
												...
												<p class="rate">
													<i class="icon-star"></i> <i class="icon-star"></i> <i
														class="icon-star"></i> <i class="icon-star"></i> <i
														class="icon-star-o"></i> <span>${travel.price}</span>
												</p>
											</div>
											<div class="two">
	...
	<script src="<%= request.getContextPath() %>/resources/js/range.js"></script>
	<script
		src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
	<script
		src="<%= request.getContextPath() %>/resources/js/google-map.js"></script>
